...
EQS = [
 ...
 ("E10","4.3  Unified transition kernel (novel)","Natural / Tollmien-Schlichting onset (low-Tu correlation surrogate)",
   r"N(x) = \int_{x_0}^{x} -\alpha_i(x')\,dx' \ge N_{crit}"),
 ...
 ("E12","4.3  Unified transition kernel (novel)","Separation-induced onset (laminar bubble)",
   r"\lambda \le -0.09 \Rightarrow Re_{\theta t,sep} = \max\left(Re_{\theta t}^{floor},\, 0.7\,Re_{\theta t,bp}\right)"),
