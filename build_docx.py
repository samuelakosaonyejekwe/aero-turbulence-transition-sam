...
para("Two elements of the formulation are not correlations. The amplification rate driving the "
 "e^N integral is tabulated in solver/amplification_db.npz from 19,712 Orr-Sommerfeld "
 "eigenvalue solutions on the Falkner-Skan family: profiles are generated by continuation, the "
...
bullet("An amplification database in place of an envelope correlation: 19,712 Orr-Sommerfeld "
...
bullet("Regime coverage with one constant set: transition-onset Re_theta_t predicted to -8.2 % "
       "on T3B, -11.9 % on T3A, -21.9 % on T3C4, -22.3 % on T3A- and +1.4 % on "
...
bullet("An aerofoil validation built for this work: 86 transition locations digitised from Fig. 9 "
       ...
       "0.038 chord, and 46 of the 86 predictions fall inside the +/-0.025c bracket within which "
