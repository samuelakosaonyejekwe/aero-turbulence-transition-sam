...
para("Measured, the two forms agree to 0.03 per cent on the four zero-pressure-gradient plates "
 "— as they must, since Re_θ = 0.664 √Re_x there — and differ by 2.85 per cent on T3C4, the "
 "one plate that carries a pressure gradient, where the Re_θ form is the correct one. On the "
 "cruise wing the transitional length moves by 0.4 per cent and the section drag by 0.02 "
 "counts. The 0.02 counts is not the point. The point is that the wing no longer sits outside "
 ...
 "equivalence can be checked rather than taken on trust.")
...
para("The gap cannot be converted into a roughness ratio by this method, and saying why is "
 ...
 "19.7 and 4.6 per cent. The elimination behind the receptivity attribution was therefore "
...
para("What would close it is a defined piece of work on the method rather than a request for "
 ...
 "both facilities while this was established: the amplification integral gives 21.8 and 51.1 "
 "per cent, the local C1 criterion 17.2 and 55.1, pooled 33.5 against 32.4. Neither dominates, "
 "so the shipped form is kept and the comparison recorded rather than the choice asserted.")
