...
| ERCOFTAC T3C4 | 2.11 | 381.3 | 265.5 | −30.4 % | separation |
...
|-----|--------|---------------|------|----------------|
| Upper surface | 46 | 0.0290 c | −0.002 c | 24 (52 %) |
| Lower surface | 40 | 0.0385 c | −0.031 c | 26 (65 %) |
| All           | 86 | 0.0334 c | −0.016 c | 50 (58 %) |
| Conditions the method accepts | 84 | 0.0314 c | −0.016 c | 50 (60 %) |
...
| Drela–Giles envelope | −11.7 % | 0.0432 c | 45/86 |
| **full model** | **+0.1 %** | **0.0334 c** | **50/86** |
...
0.5 %. The shape factor does not: the march reaches 3.39 against a measured
5.17, because it is bounded by the attached Falkner–Skan branch. The rest is
length — 0.052 m modelled against a measured lower bound of 0.10 m — and the
