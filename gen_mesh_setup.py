...
def setup_tables():
    ...
    calrows=[
        ...
        ("N_crit","from Tu","e^N amplification factor","Mack N=-8.43-2.4 ln(Tu), clamped to 0.0008<=Tu<=0.0298; 8.68 for Tu<0.08%"),
        ...
        ("CF_C1",CAL["CF_C1"],"crossflow critical Re_theta2","Arnal et al. C1 criterion; does not transfer between facilities"),
        ("CF_ratio",CAL["CF_ratio"],"theta2/theta surrogate for crossflow","set on Dagenhart & Saric; independent check in Sec. IV.C"),
        ("sigma_sep",CAL["sigma_sep"],"shear-layer amplification rate in a bubble","set on T3C4 and NLF(1)-0416 bubble measurements"),
